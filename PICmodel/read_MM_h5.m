...
posx_const=data_const.pos3.x(1,:,:,face)/1e3/(6371);
posy_const=data_const.pos3.y(1,:,:,face)/1e3/(6371);
posz_const=data_const.pos3.z(1,:,:,face)/1e3/(6371);
Vx_const=data_const.v3.x(1,:,:,face);
Vy_const=data_const.v3.y(1,:,:,face);
Vz_const=data_const.v3.z(1,:,:,face);
